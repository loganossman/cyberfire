        ...
        // console.log("a = "+a+ "  days = "+daysInWeek)
         ...
         if(mainDataref == "employeeView"){
             ...
             if(color == "green"){
                 var element = document.createElement("div");
                 obj.dt === start 
                 ? (element.className="full_calander__number current_calander__number green",element.id =month+start+year,onclick = function(){ show("employeeEdit",(month+start+year),null);})
             ...
             if(color == "grey"){
                 var element = document.createElement("div");
                 obj.dt === start 
                 ? (element.className="full_calander__number current_calander__number grey",element.id =month+start+year,onclick = function(){ show("employeeEdit",(month+start+year),null);})
                 : (element.className="full_calander__number green",element.id =month+start+year);
                 element.appendChild(document.createTextNode(start));
                 document.getElementById(("div"+x)).appendChild(element);
             }
